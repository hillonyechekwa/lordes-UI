...
const UserForm = ({ formType, action }) => {
    ...
    return (
        <main className="w-full h-full p-4 grid grid-cols-2 grid-rows-1 justify-evenly items-center">
            ...
            {
                formType === "signup"?
                <img className="w-full rounded-lg" src="/images/signupimg.webp" alt="signup page image" />
                :
            ...
            <main className="w-full mx-auto">
                ...
                <div>
                  <label htmlhtmlFor="email" className="block text-sm mb-2 dark:text-white">Email address</label>
                  <div className="relative">
                    <input type="email" id="email" name="email" className="py-3 px-2 block w-full border-gray-500 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="email-error" />
