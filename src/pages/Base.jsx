      ...
      <main className="pt-8 container mx-auto">
        <header className="max-w-[85rem] font-sans mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-3xl font-sans font-medium text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">Start your journey into seamless hair services with <span className="text-violet-600 font-semibold" >Lorde&apos;s</span></h1>
              <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">Get styled by hand-picked professionals from the comfort of any location.</p>

              <div className="mt-7 grid gap-3 w-full sm:inline-flex">
                <button className="py-6 px-20 inline-flex justify-center items-center gap-2 rounded-full border border-transparent font-semibold bg-violet-800 text-white hover:bg-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 transition-all text-lg dark:focus:ring-offset-gray-800">Get Started
