...
const MegaMenu = () => {
    return (
        <>
            <nav className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white text-gray-700 font-semibold font-sans text-sm py-6 md:py-0 dark:bg-gray-800">
                <nav className="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
                    <div className="w-full flex justify-between item-center relative md:flex md:items-center md:justify-between">
                        ...
                        <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                            <div className="overflow-hidden overflow-y-auto max-h-[75vh] scrollbar-y">
                                <div className="w-full flex md:flex-row md:items-center md:justify-between md:gap-x-7 md:mt-0 md:pl-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                                    ...
                                    <Link to="/market" className="font-medium text-gray-500 hover:text-gray-400 py-3 md:py-6 dark:text-blue-500" aria-current="page">Market</Link>

                                    <Link to="/cart" className="font-medium text-gray-500 hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500">
                                        Cart
                                    </Link>
                                </div>
                            </div>
